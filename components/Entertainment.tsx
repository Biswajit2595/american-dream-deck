  ...
  const attractions = [
    {
      ...
      description: "North America's largest indoor water park.",
    },
    {
      title: "Nickelodeon Universe",
      description: "The western hemisphere's largest indoor theme park.",
    },
    {
      title: "Big SNOW",
      description: "North America's first indoor real-snow ski resort.",
    },
    {
      title: "Angry Birds World",
      description: "Premier mini-golf and interactive center.",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-start mb-24">
          <SectionHeader
            ...
            headline={
              <>
                A Universe of <br />
                <span className="italic">Entertainment.</span>
              </>
            }
            className="flex-1"
          />
          <div className="flex-1">
            <p className="text-secondary text-lg leading-relaxed max-w-xl">
              We&apos;ve integrated global IP with world-first engineering to
              create an entertainment anchor that draws 40+ million annual
              visitors who come for the attractions and stay for the retail.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="absolute bottom-10 left-10">
            <span className="text-accent font-mono text-[10px] tracking-[0.4em] uppercase">
              Big SNOW American Dream • 16 Stories of Real Snow
            </span>
          </div>
        </motion.div>
      </div>
