        ...
        <div>
          ...
          >
            <p className="text-secondary text-xl font-light leading-relaxed">
              From flagship boutiques to exclusive limited runs, The Avenue
              provides a theatrical backdrop for legacy houses including Hermès,
              Tiffany & Co., and Saint Laurent.
            </p>
            ...
            <div className="flex flex-col gap-6">
              {[
                ...
                <div
                  key={item.label}
                  className="flex justify-between items-end border-b border-accent/10 pb-4"
                >
        ...
        <div className="relative ">
          ...
          >
            <Image
              ...
              alt="Luxury Retail"
              fill
              className="object-cover grayscale brightness-90 group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000"
            />
